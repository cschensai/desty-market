...
class ButtonCtrl {
  constructor(el) {
    ...
    this.DOM.text = this.DOM.el.querySelector('.magnetic-button-text')
    this.DOM.textinner = this.DOM.el.querySelector('.magnetic-button-text-inner')
    this.DOM.filler = this.DOM.el.querySelector('.magnetic-button-filler')
